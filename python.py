...
class IA(object): #class qui regroupe toutes les IAs.
    ...
    def IAs(choice1,choice2,turn): #fonction qui permet de passer les arguments et les choix pour lancer les IAs avec les arguments correspondant.
        ...
        if choice1 == 1 : #si le choix fait par l'utilisateur est de 1 alors l"IA qui va jouer sera un Tricheur.
            ...
            bool = IA.copieur(choice2) #on va renvoyer le résultat de la fonction du copieur dans la variable bool.
            return bool #on retourne bool pour savoir si on joue ou si on triche.
    ...
    def copieur(choice2): #L'IA du copieur consiste à faire exactement ce que à fait l'adversaire au dernier tour. Au premier tour le copieur joue vu que l'adversaire est considerer comme jouant et ne trichant pas.
...
def choix_IAs():
    ...
    print("Combien d'IA de type Tricheur voulez-vous ?")
    a = int(input()) #variable avec le nombre d'IA Enfants.

    print("Combien d'IA de type Enfant voulez-vous ?")

    b = int(input())#variable avec le nombre d'IA Tricheur.

    print("Combien d'IA de type Coequipier voulez-vous ?")

    c = int(input()) #variable avec le nombre d'IA Coequipier.

    print("Combien d'IA de type Copieur voulez-vous ?")

    d = int(input()) #variable avec le nombre d'IA Copieur.

    print("Combien d'IA de type Ivrogne voulez-vous ?")

    e = int(input()) #variable avec le nombre d'IA Ivrogne.

    print("Combien d'IA de type Indecie voulez-vous ?")

    f = int(input()) #variable avec le nombre d'IA Indécie.

    print("Combien d'IA de type Inspecteur voulez-vous ?")

    g = int(input()) #variable avec le nombre d'IA Inspecteur.
    ...
    while i != a: #Tant que i différent de a
        ...
        Liste.append(1) #on ajoute des enfants dans la liste
    ...
    while i != b: #Tant que i différent de b
        ...
        Liste.append(2) #on ajoute des Tricheurs dans la liste
        i=i+1 #permet de faire avancer la boucle et de ne pas boucler à l'infini
...
def rendu(score,a,point,gagnant): #fonction qui renvoie l'affichage des score sous forme de graphe en png.
    ...
    if nég == True : #Si la variable est négative :
        ...
        pyplot.figure(figsize = (8, 8))#donne la taille de la figure.
...
print("choisissez le nombre de point si la personne triche et gagne")
triche=int(input()) #variable qui à le nombre de point gagné si la personne triche et gagne.
print("choisissez le nombre de point si la personne joue et perd")
perd=int(input()) #variable qui à le nombre de point gagné si la personne joue et perd.
print("choisissez le nombre de point si les deux personne trichent")
perd_egau=int(input()) #variable qui à le nombre de point gagné si les deux personne trichent.
print("choisissez le nombre de point si les deux personne jouent")
joue=int(input()) #variable qui à le nombre de point gagné si les deux personne jouent.


print("Choisissez le nombre de tour")
tour=int(input()) #variable qui contient le nombre de tour.
print("choisissez combien d'IA vous voulez faire jouer")
